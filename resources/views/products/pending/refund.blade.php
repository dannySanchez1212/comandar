...
@section('page_title', __('voyager::generic.viewing').' '.__('Pending Refund'))
...
@section('page_header')
     <h1 >
       ...
       <div class="row">
                    ...
                    <div class="col-xs-5">
                        <i class="voyager-compass"></i> {{ __('Pending Refund') }}
    ...
    <form name="update_register" style="width:100%;" class="form-horizontal" id="update_register" enctype="multipart/form-data" accept-charset="UTF-8" method="post">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a aria-expanded="false" href="#details" data-toggle="tab">Pending Refund Details</a></li>
...
<h4 class="modal-title" id="myModalLabel">View Pending Refund</h4>
</div>
<div class="modal-body">

  <!--  //////////////////tabs////////////////////  -->
    <ul class="nav nav-tabs">
    <li><a href="#ViewPendingRefund1contac" data-toggle="tab">Contac</a></li>
    <li><a href="#ViewPendingRefund1address" data-toggle="tab">Address</a></li>
    </ul>
    <!--  //////////////////tabs////////////////////  -->

    <div class="tab-content">
  <!--  //////////////////contac////////////////////  -->
    <div class="tab-pane active" id="ViewPendingRefund1contac">
    ...
    <!--  //////////////////address////////////////////  -->
    <div class="tab-pane" id="ViewPendingRefund1address">
...
<!-- Bootstrap Modal - To Add New Record -->
<!-- Modal  edit-->
<form id="SavePendingRefund"  method="post">
<div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
<h4 class="modal-title" id="myModalLabel">Edit Pending Refund</h4>
</div>
<div class="modal-body">

  <!--  //////////////////tabs////////////////////  -->
    <ul class="nav nav-tabs">
    <li><a href="#editPendingRefund1contac" data-toggle="tab">Contac</a></li>
    <li><a href="#editPendingRefund1address" data-toggle="tab">Address</a></li>
    </ul>
    <!--  //////////////////tabs////////////////////  -->

    <div class="tab-content">
  <!--  //////////////////contac////////////////////  -->
    <div class="tab-pane active" id="editPendingRefund1contac">
         <div class="form-group">
        <label for="name">Name</label>
    ...
    <!--  //////////////////address////////////////////  -->
    <div class="tab-pane" id="editPendingRefund1address">
...
@section('javascript')
  ...
  $( "#SavePendingRefund" ).submit(function( event ) {

    var parametros = $(this).serialize();
     alert('parametros.........'+parametros);
       $.ajax({
          type: "POST",
          url: "/PendingRefund/Update/Save",
          data: parametros,
         ...
         setTimeout(function(){
                    swal({ title:'Success!',text:"Pending Refund Successfully Save",type:'success'});
                    location.reload();
                 },1000);
          }
      });
    ...
    <script type="text/javascript">
         $(document).on('click','#boton',function(event){
                 ...
                 var _token = '{{csrf_token()}}';
                         ...
                         swal({
                          title: 'Are you sure?',
                          text: " Pending Refund Successfully Removed!",
                          type: 'warning',
                          ...
                          if (result.value) {
                             ...
                             $.ajax({
                              url:"/PendingRefund/destroy",
                              method:"POST",
                              data:{id:id, _token:_token},
                              success:function(result){

                                swal({ title:'Deleted!',text:"Pending Refund Successfully Removed",type:'success'});
                                location.reload();
                              }
                            ...
                            swal({ title:'Cancelled',text:"Pending Refund Successfully Not Removed",type:'error'});
