...
@section('page_title', __('voyager::generic.viewing').' '.__('Todos Products'))
...
@section('page_header')
 <div class="container-fluid" style="display: flex;justify-content: flex-start!important;">
        ...
        <div  id="add_alert" class="alert alert-success" role="alert" style="display: none;width: 289px !important;">
            <strong>{{ __('Successfully Saved New Products') }}</strong>
        </div>
    ...
    <h1 style="margin-top: 2px; margin-bottom: 0px;">
       ...
       <div class="row">
                    ...
                    <div class="col-xs-10">
                        <i class="voyager-basket" style="padding-right:inherit;"></i> {{ __('Todos Los Productos') }}
...
<h4 class="modal-title" id="myModalLabel">New Products</h4>
</div>
                                ...
                                <div class="nav-tabs-custom" style="height: 85%;">
                                    ...
                                    <div class="tab-pane active" id="details" style="margin-right: 2%;">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-4">
                                              <input name="id_article" readonly=”readonly” class="form-control" id="id_article" type="text">
                                            </div>
                                        </div>
...
<form id="ApproveProducts"  method="post">
    ...
    <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
    <h4 class="modal-title" id="myModalLabel">Aprovar Produto</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="col-md-3">
            <div class="box box-primary" style="display: flex;justify-content: center;padding-right: 0px;padding-top: 0px;padding-bottom: 0px;padding-left: 0px;">
                                      ...
                                      <div class="box-body box-profile">
                                          <label>Picture</label>
                                         <img   src="http://distribucionesdp.test/img/product/product.png"  class="form-control img-responsive" name="image_approved" id="image_approved"  style="height: 251px;">
...
">
                    ...
                    <div class="box-body" >
                                ...
                                <div class="nav-tabs-custom" style="height: 85%;">
                                    <ul class="nav nav-tabs">
                                    <li class="active"><a aria-expanded="false" href="#details" data-toggle="tab">Detallles Del Producto</a></li>
                                    ...
                                    <div class="tab-pane active" id="details" style="margin-right: 2%;">
                                        ...
                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_private_approved">Private</label>

                                            <div class="col-sm-4">
                                              <input name="private_approved"  id="private_approved" type="checkbox">
                                            </div>
                                            <label class="col-sm-2 control-label" for="id_article_approved">Id Article</label>

                                            <div class="col-sm-4 space-itens">
                                              <input name="id_article_approved" required class="form-control" id="id_article_approved" type="text">
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_country_approved">Country</label>

                                            <div class="col-sm-4">
                                                <input type="text" name="country_approved" id="country_approved" class="form-control" required>
                                            </div>

                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-3 control-label" for="product_keywords_approved">Keywords</label>

                                            <div class="col-sm-9 space-itens">
                                               <textarea style="width: 100%;
                                               height: 14%;
                                               min-height: 39px !important;" required class="form-control" name="keywords_approved" id="keywords_approved" cols="30" rows="10" >Tasche für Nintendo Switch Lite 2019</textarea>
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_brand_approved">Brand</label>

                                            <div class="col-sm-4">
                                              <input name="brand_approved" required class="form-control" id="brand_approved" type="text" value="Tikola">
                                            </div>
                                            <label class="col-sm-2 control-label" for="Product_store_approved">Store</label>

                                            <div class="col-sm-4 space-itens">
                                              <input name="store_approved" required class="form-control" id="store_approved" type="text" value=" Tikola EU">
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_asin_approved">Asin</label>

                                            <div class="col-sm-4">
                                              <input name="asin_approved" required class="form-control" id="asin_approved" type="text" value="B07WDV5HY3">
                                            </div>
                                            <label class="col-sm-2 control-label" for="Product_cover_fees_approved">Cover Fees</label>

                                            <div class="col-sm-4 space-itens">
                                                <input name="cover_fees_approved"   id="cover_fees_approved" type="checkbox">
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_price_approved">Price</label>

                                            <div class="col-sm-4">
                                              <input name="price_approved" required class="form-control" id="price_approved" type="text" value="12,99">
                                            </div>
                                            <label class="col-sm-2 control-label" for="Product_condition_refund_approved">Condition Refund</label>

                                            <div class="col-sm-4 space-itens">
                                                <input type="text" required class="form-control" name="condition_refund_approved" id="condition_refund_approved" value="Picture Review 5 Stars">
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_link_approved">Link</label>

                                            <div class="col-sm-6 space-itens">
                                                <a id="linkDinamic_approved" href="#" class="automatic bb-link bb-stop-propagation" target="_blank">LINK ARTICLE</a>
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_info_approved">Info</label>

                                            <div class="col-sm-9 space-itens">
                                               <textarea required style="width: 100%;
                                               height: 14%;
                                               min-height: 39px !important;" class="form-control" name="info_approved" id="info_approved" cols="30" rows="10" >Need Pictures in review</textarea>
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label" for="product_commission_approved">Commission Agent</label>

                                            <div class="col-sm-6 space-itens">
                                                    <input required class="form-control" name="commission_approved" id="commission_approved" type="text" value="2,40">
                                             </div>
                                        </div>
     ...
     <!-- Main content -->
        <section class="content-product">
            ...
            <div class="outer_div" style="width:100%;">
                    ...
                    @include('products.New.productNew')
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
  ...
  <script type="text/javascript">
   ...
   //  alert('pais='+pais);
    ...
    var modal = $(this)
      modal.find('.modal-title').text('Aprovar Producto: ')
      modal.find('.modal-body #private_approved').val(private)
      modal.find('.modal-body #id_article_approved').val(id_article)
      modal.find('.modal-body #country_approved').val(country)
      modal.find('.modal-body #brand_approved').val(brand)
      modal.find('.modal-body #keywords_approved').val(keywords)
      modal.find('.modal-body #story_approved').val(story)
      modal.find('.modal-body #asin_approved').val(asin)
      modal.find('.modal-body #cover_fees_approved').val(cover_fees)
      modal.find('.modal-body #price_approved').val(price)
      modal.find('.modal-body #condition_refund_approved').val(condition_refund)
      modal.find('.modal-body #info_approved').val(info)
      modal.find('.modal-body #commission_agent_approved').val(commission_agent)
      modal.find('.modal-body #image_approved').attr('src',picture)
      document.getElementById('linkDinamic_approved').href = link;
  ...
  $( "#SaveProducts" ).submit(function( event ) {
   ...
   //  alert('parametros.........'+parametros);
       $.ajax({
         ...
         setTimeout(function(){
                    swal({ title:'Success!',text:"Producto Guardado Exitosamente",type:'success'});
                    location.reload();
                 },1000);
          }
      });
    ...
    $( "#ApproveProducts" ).submit(function( event ) {
        ...
        var id = $("#id_article_approved").val();
       // alert('id = '+id);
        var private = $("#private_approved").val();
       // alert('private = '+private);
        var country = $("#country_approved").val();
       // alert('country = '+country);
        var brand = $("#brand_approved").val();
       // alert('brand = '+brand);
        var keywords = $("#keywords_approved").val();
      //  alert('keywords = '+keywords);
        var story = $("#story_approved").val();
       // alert('story = '+story);
        var asin = $("#asin_approved").val();
       // alert('asin = '+asin);
        var cover_fees = $("#cover_fees_approved").val();
       // alert('cover_fees = '+cover_fees);
        var condition_refund = $("#condition_refund_approved").val();
      //  alert('condition_refund = '+condition_refund);
        var price = $("#price_approved").val();
      //  alert('price = '+price);
        var link = $("#linkDinamic_approved").val();
      //  alert('link = '+link);
        var info = $("#info_approved").val();
      //  alert('info = '+info);
        var commission_agent = $("#commission_agent_approved").val();
       // alert('commission_agent = '+commission_agent);
        var picture = $("#image_approved").val();
       // alert('info = '+picture);
        ...
        $.ajax({
            ...
            success: function(datos){
                $('#edit_modal').modal('hide');
                setTimeout(function(){
                            swal({ title:'Success!',text:"Produto Guardado",type:'success'});
                            location.reload();
                        },1000);
            },
            error:function(datos){
                        setTimeout(function(){
                                swal({ title:'Cancelled',text:"Error Produto",type:'error'});
