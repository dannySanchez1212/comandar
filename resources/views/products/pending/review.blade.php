...
@section('page_title', __('voyager::generic.viewing').' '.__('Pending Review'))
...
@section('page_header')
     <h1 >
                ...
                <div class="row" style="padding-top: 6% !important;">
                    ...
                    <div class="col-xs-5">
                        <i class="voyager-compass"></i> {{ __('Pending Review') }}
    ...
    <form name="update_register" style="width:100%;" class="form-horizontal" id="update_register" enctype="multipart/form-data" accept-charset="UTF-8" method="post">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a aria-expanded="false" href="#details" data-toggle="tab">Pending Review Details</a></li>
...
<h4 class="modal-title" id="myModalLabel">View Pending Review</h4>
</div>
<div class="modal-body">

  <!--  //////////////////tabs////////////////////  -->
    <ul class="nav nav-tabs">
    <li><a href="#ViewPendingReview1contac" data-toggle="tab">Contac</a></li>
    <li><a href="#ViewPendingReview1address" data-toggle="tab">Address</a></li>
    </ul>
    <!--  //////////////////tabs////////////////////  -->

    <div class="tab-content">
  <!--  //////////////////contac////////////////////  -->
    <div class="tab-pane active" id="ViewPendingReview1contac">
    ...
    <!--  //////////////////address////////////////////  -->
    <div class="tab-pane" id="ViewPendingReview1address">
...
<!-- Bootstrap Modal - To Add New Record -->
<!-- Modal  edit-->
<form id="SavePendingReview"  method="post">
<div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
<h4 class="modal-title" id="myModalLabel">Edit Pending Review</h4>
</div>
<div class="modal-body">

  <!--  //////////////////tabs////////////////////  -->
    <ul class="nav nav-tabs">
    <li><a href="#editPendingReview1contac" data-toggle="tab">Contac</a></li>
    <li><a href="#editPendingReview1address" data-toggle="tab">Address</a></li>
    </ul>
    <!--  //////////////////tabs////////////////////  -->

    <div class="tab-content">
  <!--  //////////////////contac////////////////////  -->
    <div class="tab-pane active" id="editPendingReview1contac">
         <div class="form-group">
        <label for="name">Name</label>
    ...
    <!--  //////////////////address////////////////////  -->
    <div class="tab-pane" id="editPendingReview1address">
        ...
        <section class="content">
            ...
            <div class="outer_div">
                <div class="row">
                    ...
                    @include('products.pending.tables.tablependingRefunds')
...
@section('javascript')
  ...
  <script type="text/javascript">
    ...
    var modal = $(this)
      modal.find('.modal-title').text('View Pending Review: ')
    ...
    //  alert('street='+street);
     ...
     // alert('contac_name='+contac_name);
    var modal = $(this)
      modal.find('.modal-title').text('View Pending Refund: ')
      modal.find('.modal-body #documents').val(documents)
      modal.find('.modal-body #name').val(name)
       modal.find('.modal-body #last_name').val(lastname)
       modal.find('.modal-body #email').val(email)
  ...
  $( "#SavePendingReview" ).submit(function( event ) {

    var parametros = $(this).serialize();
     alert('parametros.........'+parametros);
       $.ajax({
          type: "POST",
          url: "/PendingReview/Update/Save",
          data: parametros,
         ...
         setTimeout(function(){
                    swal({ title:'Success!',text:"Pending Review Successfully Save",type:'success'});
                    location.reload();
                 },1000);
          }
      });
    ...
    <script type="text/javascript">
         $(document).on('click','#boton',function(event){
                 ...
                 var _token = '{{csrf_token()}}';
                         ...
                         swal({
                          title: 'Are you sure?',
                          text: " Pending Review Successfully Removed!",
                          type: 'warning',
                          ...
                          if (result.value) {
                             ...
                             $.ajax({
                              url:"/PendingReview/destroy",
                              method:"POST",
                              data:{id:id, _token:_token},
                              success:function(result){

                                swal({ title:'Deleted!',text:"Pending Review Successfully Removed",type:'success'});
                                location.reload();
                              }
                            ...
                            swal({ title:'Cancelled',text:"Pending Review Successfully Not Removed",type:'error'});
