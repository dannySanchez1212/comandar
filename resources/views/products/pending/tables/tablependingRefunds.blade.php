                             ...
                             <table id="dataTables" class="table table-hover dataTable no-footer" role="grid" aria-describedby="dataTable_info">
                               <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 120px;">Country</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 150px;">Brand</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Store</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Price</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Order Date</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Order Id</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Order Nº Added</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Order Picture</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Email Buyer</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Privat Note</th>

                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="symbol : activate to sort column ascending" style="width: 100px;">Link Amazon Profil</th>
                                ...
                                <tbody>
                                        ...
                                        @if ($Product->id)
                                                    <tr>
                                                        ...
                                                        <td>{{ $Product->link }}</td>
                                                        <td>{{ $Product->info }}</td>
                                                        <td>{{ $Product->commission_agent }}</td>
                                                        <!-- Falta modificar de acuerdo a la table -->
                                                        <td>{{ $Product->cover_fees }}</td>
                                                        <td>{{ $Product->price }}</td>
                                                        <td>{{ $Product->condition_refund }}</td>
                                                        <td>{{ $Product->link }}</td>
