...
class pendingRefundController extends Controller
{
        ...
        public function index(Request $request)
        {
            ...
            $users = User::all();
            $view = 'products.pending.refund';

            if (view()->exists("products.pending.refund")) {
                $view = "products.pending.refund";
            }
        ...
        public function editItems(Request $request) {
          ...
          //  soldToday:soldToday, maxOrdersPerWeek:maxOrdersPerWeek, soldWeek:soldWeek, maxOrdersTotal:maxOrdersTotal,
           ...
           // dd($Category[0]->id);
             ...
             return  view('products.pending.refund', compact('Products','countrys','users'));
         ...
         //   dd($request);
           ...
           // dd($Category[0]->id);
             ...
             return Voyager::view('products.pending.refund', compact('Products','Categories','Makers'));
