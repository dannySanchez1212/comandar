...
class pendingCommissionController extends Controller
{
        ...
        public function index(Request $request)
        {
            ...
            $users = User::all();
            $view = 'products.pending.commission';

            if (view()->exists("products.pending.commission")) {
                $view = "products.pending.commission";
            }
        ...
        public function editItems(Request $request) {
          ...
          //  soldToday:soldToday, maxOrdersPerWeek:maxOrdersPerWeek, soldWeek:soldWeek, maxOrdersTotal:maxOrdersTotal,
           ...
           // dd($Category[0]->id);
             ...
             return  view('products.pending.commission', compact('Products','countrys','users'));
         ...
         //   dd($request);
           ...
           // dd($Category[0]->id);
             ...
             return Voyager::view('products.pending.commission', compact('Products','Categories','Makers'));
