...
class pendingMyCommissionController extends Controller
{
        ...
        public function index(Request $request)
        {
            ...
            $users = User::all();
            $view = 'products.pending.mycommission';

            if (view()->exists("products.pending.mycommission")) {
                $view = "products.pending.mycommission";
            }
        ...
        public function editItems(Request $request) {
            ...
            $file = $request->file('pictureinput');
                ...
                if($Products->image){
                 ...
                 //private:private, outOfStock:outOfStock, country:country,
          ...
          //  soldToday:soldToday, maxOrdersPerWeek:maxOrdersPerWeek, soldWeek:soldWeek, maxOrdersTotal:maxOrdersTotal,
           ...
           // dd($Category[0]->id);
             ...
             return  view('products.pending.mycommission', compact('Products','countrys','users'));
         ...
         //   dd($request);
           ...
           // dd($Category[0]->id);
             ...
             return Voyager::view('products.pending.mycommission', compact('Products','Categories','Makers'));
