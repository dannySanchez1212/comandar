...
class pendingOrderController extends Controller
{
        ...
        public function index(Request $request)
        {
            ...
            $users = User::all();
            $view = 'products.pending.order';

            if (view()->exists("products.pending.order")) {
                $view = "products.pending.order";
            }
        ...
        public function editItems(Request $request) {
          ...
          //  soldToday:soldToday, maxOrdersPerWeek:maxOrdersPerWeek, soldWeek:soldWeek, maxOrdersTotal:maxOrdersTotal,
           ...
           // dd($Category[0]->id);
             ...
             return  view('products.pending.order', compact('Products','countrys','users'));
         ...
         //   dd($request);
           ...
           // dd($Category[0]->id);
             ...
             return Voyager::view('products.pending.order', compact('Products','Categories','Makers'));
