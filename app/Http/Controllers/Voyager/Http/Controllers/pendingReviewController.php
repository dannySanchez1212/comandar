...
class pendingReviewController extends Controller
{
        ...
        public function index(Request $request)
        {
            ...
            $users = User::all();
            $view = 'products.pending.review';

            if (view()->exists("products.pending.review")) {
                $view = "products.pending.review";
            }
        ...
        public function editItems(Request $request) {
          ...
          //  soldToday:soldToday, maxOrdersPerWeek:maxOrdersPerWeek, soldWeek:soldWeek, maxOrdersTotal:maxOrdersTotal,
           ...
           // dd($Category[0]->id);
             ...
             return  view('products.pending.review', compact('Products','countrys','users'));
         ...
         //   dd($request);
           ...
           // dd($Category[0]->id);
             ...
             return Voyager::view('products.pending.review', compact('Products','Categories','Makers'));
