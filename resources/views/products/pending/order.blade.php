...
@section('page_title', __('voyager::generic.viewing').' '.__('Pending Order'))
...
@section('page_header')
     <h1 >
       ...
       <div class="row">
                    ...
                    <div class="col-xs-5">
                        <i class="voyager-compass"></i> {{ __('Pending Order') }}
    ...
    <form name="update_register" style="width:100%;" class="form-horizontal" id="update_register" enctype="multipart/form-data" accept-charset="UTF-8" method="post">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a aria-expanded="false" href="#details" data-toggle="tab">Pending Order Details</a></li>
...
<h4 class="modal-title" id="myModalLabel">View Pending Order</h4>
</div>
<div class="modal-body">

  <!--  //////////////////tabs////////////////////  -->
    <ul class="nav nav-tabs">
    <li><a href="#ViewPendingO1contac" data-toggle="tab">Contac</a></li>
    <li><a href="#ViewPendingO1address" data-toggle="tab">Address</a></li>
    </ul>
    <!--  //////////////////tabs////////////////////  -->

    <div class="tab-content">
  <!--  //////////////////contac////////////////////  -->
    <div class="tab-pane active" id="ViewPendingO1contac">
    ...
    <!--  //////////////////address////////////////////  -->
    <div class="tab-pane" id="ViewPendingO1address">
...
<!-- Bootstrap Modal - To Add New Record -->
<!-- Modal  edit-->
<form id="SavePendingO"  method="post">
<div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
<h4 class="modal-title" id="myModalLabel">Edit Pending Order</h4>
</div>
<div class="modal-body">

  <!--  //////////////////tabs////////////////////  -->
    <ul class="nav nav-tabs">
    <li><a href="#editPendingO1contac" data-toggle="tab">Contac</a></li>
    <li><a href="#editPendingO1address" data-toggle="tab">Address</a></li>
    </ul>
    <!--  //////////////////tabs////////////////////  -->

    <div class="tab-content">
  <!--  //////////////////contac////////////////////  -->
    <div class="tab-pane active" id="editPendingO1contac">
         <div class="form-group">
        <label for="name">Name</label>
    ...
    <!--  //////////////////address////////////////////  -->
    <div class="tab-pane" id="editPendingO1address">
        ...
        <section class="content content-edit">
            ...
            <div class="outer_div">
                <div class="row">
                    ...
                    @include('products.pending.tables.tableOrder')
...
@section('javascript')
  ...
  <script type="text/javascript">
    ...
    var modal = $(this)
      modal.find('.modal-title').text('View Pending Order: ')
  ...
  $( "#SavePendingO" ).submit(function( event ) {

    var parametros = $(this).serialize();
     alert('parametros.........'+parametros);
       $.ajax({
          type: "POST",
          url: "/PendingO/Update/Save",
          data: parametros,
         ...
         setTimeout(function(){
                    swal({ title:'Success!',text:"Pending Order Successfully Save",type:'success'});
                    location.reload();
                 },1000);
          }
      });
    ...
    <script type="text/javascript">
         $(document).on('click','#boton',function(event){
                 ...
                 var _token = '{{csrf_token()}}';
                         ...
                         swal({
                          title: 'Are you sure?',
                          text: " Pending Order Successfully Removed!",
                          type: 'warning',
                          ...
                          if (result.value) {
                             ...
                             $.ajax({
                              url:"/PendingO/destroy",
                              method:"POST",
                              data:{id:id, _token:_token},
                              success:function(result){

                                swal({ title:'Deleted!',text:"Pending Order Successfully Removed",type:'success'});
                                location.reload();
                              }
                            ...
                            swal({ title:'Cancelled',text:"Pending Order Successfully Not Removed",type:'error'});
